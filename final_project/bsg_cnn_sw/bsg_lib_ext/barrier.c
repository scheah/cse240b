...
// Use magic number to check outstanding remote packets
// magic number for "all packets" -> A119AC
#define bsg_commit_stores_wait() bsg_wait_while(*bsg_remote_ptr(bsg_tiles_X, 0, 0xA119AC))
...
#ifdef USE_BROADCAST_IMPL // SW based
#pragma message ( "SW Barrier Control" )
...
#else
// Centralized control - Need HW modification to track outstanding remote packets
#define BARRIER_CENTRAL_X 0 
#define BARRIER_CENTRAL_Y 0
#pragma message ( "HW-supporting Barrier Control" )
